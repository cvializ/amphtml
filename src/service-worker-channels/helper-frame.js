...
// TODO(cvializ): how generic can I make this?
// TODO(cvializ): Make subclassable and the only difference would really be the run method

import {parseQueryString} from '../../../src/url.js';
import {WindowMessenger} from '../../../src/service-worker-messaging/window-messenger';
...
export class HelperFrame {
  ...
  */
   ...
   * worker.
   *
   * @param {string|null} unusedAllowedOrigin For testing purposes only. Pass in the
   * allowedOrigin since test environments cannot access the parent origin.
   */
  run(unusedAllowedOrigin) {
